...
### Raspberry PI
下载 [iotcli_v1.0.4_Linux-ARMv7.tar.gz][dl-arm]
### Linux
下载 [iotcli_v1.0.4_Linux-amd64.tar.gz][dl-linux]
### macOS
下载 [iotcli_v1.0.4_macOS-amd64.tar.gz][dl-mac]
### Windows
下载 [iotcli_v1.0.4_Windows-amd64.zip][dl-win]
