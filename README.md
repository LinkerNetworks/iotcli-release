...
### Raspberry PI
Download [iotcli_v1.0.4_Linux-ARMv7.tar.gz][dl-arm]
### Linux
Download [iotcli_v1.0.4_Linux-amd64.tar.gz][dl-linux]
### macOS
Download [iotcli_v1.0.4_macOS-amd64.tar.gz][dl-mac]
### Windows
Download [iotcli_v1.0.4_Windows-amd64.zip][dl-win]
...
[dl-linux]: https://github.com/LinkerNetworks/iotcli-release/releases/download/v1.0.4/iotcli_v1.0.4_Linux-amd64.tar.gz
[dl-arm]: https://github.com/LinkerNetworks/iotcli-release/releases/download/v1.0.4/iotcli_v1.0.4_Linux-ARMv7.tar.gz
[dl-mac]: https://github.com/LinkerNetworks/iotcli-release/releases/download/v1.0.4/iotcli_v1.0.4_macOS-amd64.tar.gz
[dl-win]: https://github.com/LinkerNetworks/iotcli-release/releases/download/v1.0.4/iotcli_v1.0.4_Windows-amd64.zip
